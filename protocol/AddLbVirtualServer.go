//  http://manual.iij.jp/gp/gpapi/12442744.html

package protocol

type AddLbVirtualServerArg struct {
	...
	VirtualServerName string   `gpapi:"VirtualServerName,required"` // 追加するLB仮想サービスの名称
}

type AddLbVirtualServerResponse struct {
